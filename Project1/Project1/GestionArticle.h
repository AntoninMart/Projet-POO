...
namespace Project1 {
	...
	/// </summary>
	public ref class GestionArticle : public System::Windows::Forms::Form
	{
	public:
		GestionArticle(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(GestionArticle::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &GestionArticle::button1_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.BackgroundImage")));
			this->pictureBox1->Location = System::Drawing::Point(405, 267);
